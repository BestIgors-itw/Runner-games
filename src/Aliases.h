...
#define menu_plate_y screen_height - 108 - i * 110
...
#define Scroll_Shooter_background_scale_y float(screen_height) / 183.0
#define Race_background_scale_x float(screen_width) / 275.0
#define Race_background_scale_y float(screen_height) / 183.0
#define Shooter_background_scale_x float(screen_width) / 3542.0
#define Shooter_background_scale_y float(screen_height) / 1494.0
...
#define Effects_bullets_spawn_x (*it_bullets)->get_x() + (*it_bullets)->get_w() / 2
#define Effects_bullets_spawn_y (*it_bullets)->get_y() + (*it_bullets)->get_h() / 2

#define effects_explosion1_exist_time 0.1
#define effects_explosion2_exist_time 0.25

#define interface_plate_x screen_width
#define interface_plate_y screen_height
#define interface_text_x screen_width - 400
#define interface_text_y screen_height - 120
...
#define Scroll_Shooter_enemy_down_spawn_y screen_height + 300
...
#define enemy_shot_point_x (*it_enemies)->get_x() + (*it_enemies)->get_w() / 2
#define enemy_shot_down_point_y (*it_enemies)->get_y() + (*it_enemies)->get_h()
#define enemy_shot_up_point_y (*it_enemies)->get_y()
